...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim', type=int, default=2, metavar='IN',
                        help='Number of features as input of the model (default: 2)')
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='HI',
                        help='Number of nodes in the hidden layer of the network (default: 10)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                        help='Output dimension of the neural network (default: 1)')
